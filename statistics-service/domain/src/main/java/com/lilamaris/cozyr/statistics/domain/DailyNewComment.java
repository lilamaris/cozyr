...
@Entity
@Table(name = "daily_new_comment")
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class DailyNewComment {
    @EmbeddedId
    private DailyNewCommentId id;
    ...
    private DailyNewComment(DailyNewCommentId id, long createdCount, Instant createdAt, Instant updatedAt) {
    ...
    public static DailyNewComment of(long postId, LocalDate createdDate, long createdCount, Instant createdAt) {
        var id = DailyNewCommentId.of(postId, createdDate);
        return new DailyNewComment(id, createdCount, createdAt, createdAt);
    }
}
