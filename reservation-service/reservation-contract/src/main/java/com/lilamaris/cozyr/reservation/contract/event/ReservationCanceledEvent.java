...
public record ReservationCanceledEvent(
    ...
    public static ReservationCanceledEvent of(UUID reservationId, LocalDate reservationDate, UUID roomId, UUID seatId, UUID requestedUserId, List<LocalTimeSchedule> schedules) {
