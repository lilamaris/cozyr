...
include("identity-service:scope-provider")

include("statistics-service:statistics-contract")
...
include("reservation-service:reservation-contract")
include("reservation-service:domain")
include("reservation-service:application")
include("reservation-service:jpa")
include("reservation-service:web")
include("reservation-service:security")
include("reservation-service:kafka")
include("reservation-service:launcher")
